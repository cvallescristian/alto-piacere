<div id="main-container">
	...
	<div class="col-md-6 col-md-offset-3">
		<div class="panel panel-default">
			<form class="form-horizontal form-border no-margin" id="basic-constraint" action="<?= base_url('admin/editar_slider_grande_action')?>"enctype="multipart/form-data" method="post" >
