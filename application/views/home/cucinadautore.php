...
<div class="container">
    ...
    <div class="big_text1">Alto Piacere...</div>
    
    <div class="clearfix mar_top3"></div>
    
    <img src="images/local.jpg" width="132" alt="" class="image_left4" />
    
    <p><strong>There are many variations of passages of Lorem Ipsum available, but the majority have alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</strong></p>
    ...
    <div class="punchline_text_box">
        <div class="left">
        <strong>Internet tend to repeat predefined making this the first true generators.</strong>
        <p>Latin words, consectetur and going through as the cites of the word in classical literature discoveres
