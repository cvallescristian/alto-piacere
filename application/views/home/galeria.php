        ...
        <ul class="gallery clearfix">
            <li>
                ...
                <?php foreach ($lista_galeria as $galeria) { ?>
                  <li class="border_threecol"><a href="<?= base_url('images/galeria/'.$galeria->galeria_id.'.png')?>" title="prettyPhoto"><img src="<?= base_url('images/galeria/'.$galeria->galeria_id.'.png')?>" alt="" /></a>
                  </li>
